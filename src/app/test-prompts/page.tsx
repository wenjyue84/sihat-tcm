...
export default function TestPromptsPage() {
    // Chat test state
    const [chatMessage, setChatMessage] = useState('I have been experiencing headaches for the past week');
            ...
            const mockData = {
                ...
                wen_chat: {
                    chat: [
                        ...
                        { role: 'assistant', content: 'I understand you experience fatigue. Is the tiredness worse after eating meals?' },
                        { role: 'user', content: 'Yes, I feel very sleepy after lunch' },
                        { role: 'assistant', content: 'Do you experience any bloating or discomfort in your stomach area?' },
                        ...
                        { role: 'assistant', content: 'Do you tend to feel cold, especially in your hands and feet?' },
                        { role: 'user', content: 'Yes, my hands and feet are always cold' }
                    ]
                },
                wang_tongue: {
                    observation: 'Pale, swollen tongue body with teeth marks on the edges. Thin white coating. The tongue appears moist.',
                    potential_issues: ['Spleen Qi deficiency', 'Yang deficiency', 'Dampness']
                },
                wang_face: {
                    observation: 'Sallow yellowish complexion with slightly puffy appearance. Mild dark circles under eyes. Dull luster.',
                ...
                {imageExpanded && (
                    <CardContent className="pt-4 space-y-4">
                        ...
                        <div className="flex gap-2">
                            ...
                            <Button
                                variant="outline"
                                onClick={() => { setImageResult(null); setImageData(null); }}
