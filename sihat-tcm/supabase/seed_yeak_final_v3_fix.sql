-- ============================================================================
-- FINAL COMPLETE FIX: SCHEMA UPDATE + DATA SEED FOR YEAK KIEW AI
-- ============================================================================
-- ERROR FIX: This script first creates the missing columns (symptoms, medicines, etc.)
-- and THEN populates the data.
-- ============================================================================
...
BEGIN
    ...
    IF v_user_id IS NULL THEN
        RAISE EXCEPTION 'User "yeak@gmail.com" not found! Please create the account in Authentication first.';
    END IF;
    ...
    INSERT INTO public.profiles (
        id, role, full_name, age, gender, height, weight, medical_history, preferred_language
    ) VALUES (
        v_user_id,
        'patient',
        'Yeak Kiew Ai',
    ...
    -- Insert Comprehensive Medical Record
    ...
    RAISE NOTICE '✅ SUCCESS: Data for Yeak Kiew Ai has been populated.';
END $$;
