...
#### 👁️ Observation (望 Wàng) - *Computer Vision*
...
#### 👂 Listening & Smelling (闻 Wén) - *Audio Analysis*
...
#### 💬 Inquiry (问 Wèn) - *Conversational AI*
...
#### 👆 Palpation (切 Qiè) - *Interactive & IoT*
...
*   **AI Engine**: **Google Gemini 2.0 & 1.5** ecosystem.
    *   *Master Level*: Uses `gemini-2.5-pro` for deep, complex case synthesis.
    *   *Expert Level*: Uses `gemini-2.5-flash` for rapid, efficient analysis.
    *   *Physician Level*: Uses `gemini-2.0-flash` for standard checkups.
...
5.  **Multi-User Roles**:
    *   *Patient*: Taking consultations.
    *   *Doctor*: Verifying AI reports (Hybrid AI-Human loop).
