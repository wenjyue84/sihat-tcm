...
### 4.2 Step 2: Inquiry (问诊 Wèn Zhěn)
...
### 4.3 Step 3: Observation - Tongue (望诊 - 舌诊)
...
1. **Using Camera** (Recommended):
   ...
   - Follow the on-screen guide:
     - Stick out your tongue naturally
     - Ensure good lighting (natural light is best)
     - Keep your tongue flat and relaxed
     - Make sure the entire tongue is visible
   - Click "Capture" when ready
   - Review the image
   - Click "Retake" if needed, or "Continue" if satisfied

2. **Using Upload** (Alternative):
   - Click "Upload Image"
   - Select a clear photo of your tongue
...
### 4.4 Step 4: Observation - Face (望诊 - 面诊)
...
**What happens next**: Continue to the Audio step.

---

### 4.5 Step 5: Listening (闻诊 Wén Zhěn)
...
### 4.6 Step 6: Pulse (切诊 Qiè Zhěn)

**What this is**: Measurement of your pulse rate and quality
...
### 4.7 Step 7: Smart Connect (Optional)
...
**What happens next**: Proceed to Summary and Analysis.
...
- **Herbal Formulas**: Traditional TCM prescriptions (if applicable)
- **Lifestyle Advice**: Sleep, exercise, and emotional wellness tips
...
1. **Review the recommendations**: Read through all sections carefully
2. **Start with lifestyle changes**: These are safe and can be implemented immediately
...
- Share history with practitioners
...
A: The AI uses advanced models trained on TCM knowledge, but accuracy depends on the quality of information you provide. For best results, be thorough and honest in your responses.
...
A: TCM diagnosis is holistic. The AI needs comprehensive information to identify the root cause, not just treat symptoms.

**Q: Can I have multiple patterns at once?**
A: Yes. TCM recognizes that multiple patterns can coexist. The AI will identify primary and secondary patterns.

**Q: What if I don't understand the diagnosis?**
A: Use the "Report Q&A" feature to ask questions. You can also consult a TCM practitioner to explain the diagnosis in detail.
...
**Q: Can I combine TCM with Western medicine?**
A: Yes, but inform both your TCM practitioner and Western doctor about all treatments you're receiving to avoid interactions.
...
A: Modern browsers including Chrome, Firefox, Edge, and Safari. For best experience, use the latest version.

**Q: Is there an offline mode?**
A: No. Sihat TCM requires an internet connection for AI processing and data storage.
...
### Diagnosis Steps Checklist

- [ ] Step 1: Basic Information
- [ ] Step 2: Inquiry (Chat with AI)
- [ ] Step 3: Tongue Photo
- [ ] Step 4: Face Photo
- [ ] Step 5: Audio Recording (Optional)
- [ ] Step 6: Pulse Measurement
- [ ] Step 7: Smart Connect (Optional)
...
2. **Be honest**: Accurate information = accurate diagnosis
3. **Take good photos**: Well-lit, clear images
...
**Ben (本)**: Root cause in TCM
**Biao (标)**: Symptoms or manifestations
