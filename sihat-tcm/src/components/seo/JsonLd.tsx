...
const webApplicationData = {
  ...
  description:
    "AI-powered Traditional Chinese Medicine diagnostic tool featuring tongue analysis, symptom assessment, and personalized health recommendations.",
  url: BASE_URL,
...
const serviceData = {
  ...
  description:
    "Get instant Traditional Chinese Medicine health insights using AI-powered tongue analysis, symptom assessment, and personalized recommendations based on ancient healing wisdom.",
  provider: {
    "@type": "Organization",
    name: "Sihat TCM",
    url: BASE_URL,
    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          ...
          description:
            "AI-powered analysis of tongue color, coating, and shape for health insights",
        },
      },
      {
        "@type": "Offer",
