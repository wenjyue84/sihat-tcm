...
export function ProfileSummaryStep({ data, onContinue, onEditProfile }: ProfileSummaryStepProps) {
  ...
  const getBmiCategory = (bmiValue: number) => {
    if (bmiValue < 18.5)
      return {
        label: t.basicInfo.bmiExplanation?.underweight || "Underweight",
        color: "text-yellow-600",
      };
    if (bmiValue < 25)
      return { label: t.basicInfo.bmiExplanation?.normal || "Normal", color: "text-emerald-600" };
    if (bmiValue < 30)
      return {
        label: t.basicInfo.bmiExplanation?.overweight || "Overweight",
    ...
    <div className="space-y-6">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-stone-500">
          {t.basicInfo.lockedProfile?.reviewSubtitle ||
            "Your profile information is ready. Click Continue to proceed."}
        </p>
      </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-stone-50 rounded-xl p-4 text-center">
              ...
              <div className="font-semibold text-stone-700">
                {data.age} {t.analysisLoading?.yearsOld || "years old"}
              </div>
            </div>
            ...
            <div className="bg-stone-50 rounded-xl p-4 text-center">
              ...
              <div className="font-semibold text-stone-700">
                {data.height} {t.basicInfo.heightUnit || "cm"}
              </div>
            </div>
            ...
            <div className="bg-stone-50 rounded-xl p-4 text-center">
              ...
              <div className="font-semibold text-stone-700">
                {data.weight} {t.basicInfo.weightUnit || "kg"}
              </div>
            </div>
          </div>
            ...
            <div className="p-4 bg-emerald-50/50 rounded-xl border border-emerald-100">
              <div className="flex items-center gap-3 text-emerald-700">
                ...
                <span className="text-sm font-medium">
                  {t.basicInfo.lockedProfile?.profileReady ||
                    "Profile information is complete and ready"}
                </span>
              </div>
            </div>
          ) : (
              ...
              <div className="flex items-center gap-3 text-amber-700">
                ...
                <div>
                  ...
                  <span className="text-xs text-amber-600">
                    {t.basicInfo.lockedProfile?.missingFields ||
                      "Some information is missing (age, gender, height, or weight)"}
                  </span>
                </div>
              </div>
            </div>
