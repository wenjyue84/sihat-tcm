                ...
                <div className="flex flex-col items-center text-center space-y-4">
                    ...
                    <div className="space-y-3 w-full">
                        ...
                        <div className="flex flex-wrap justify-center gap-1.5 mt-2">
                            {['国家级高新技术企业', '科技型中小企业', '创新型中小企业', '专精特新中小企业'].map((tag, i) => (
                                <span key={i} className="text-[10px] px-1.5 py-0.5 border border-emerald-100 text-emerald-700 bg-emerald-50 rounded">
                                    {tag}
                                </span>
                            ))}
                        </div>
            ...
            <div className="px-4 py-2 bg-stone-50 border-t border-stone-100 text-center">
                ...
                <div className="flex justify-center gap-1.5 mt-2">
                    {slides.map((_, idx) => (
                        <div
                            key={idx}
                            className={`h-1 rounded-full transition-all duration-300 ${idx === currentIndex ? 'w-4 bg-emerald-500' : 'w-1 bg-stone-300'
                                }`}
                        />
                    ))}
                </div>
