  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3" role="radiogroup" aria-labelledby="gender-label">
        <Label id="gender-label" className="text-muted-foreground font-medium">
          {t.basicInfo.gender}
        </Label>
        <div className="grid grid-cols-3 gap-3">
          {[
            ...
            >
              ...
              <span
                className={`text-sm font-medium ${formData.gender === gender.value ? "text-primary" : "text-muted-foreground"}`}
              >
                {gender.label}
              </span>
              {formData.gender === gender.value && (
