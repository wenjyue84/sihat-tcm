    ...
    citations: [
      {
        ...
        title:
          "Automated tongue segmentation and pathology detection for Traditional Chinese Medicine diagnosis",
...
const translations = {
  en: {
    ...
    subtitle:
      "Our AI-powered tongue diagnosis is based on peer-reviewed research and clinical evidence from Traditional Chinese Medicine studies.",
    researchBacked: "Research-Backed Approach",
    researchBackedDescription:
      "Our platform uses 7 specialized AI models trained on 10,000+ clinically validated tongue images, incorporating findings from these peer-reviewed studies to provide accurate TCM pattern recognition.",
    viewDoi: "View DOI",
  },
  zh: {
    buttonLabel: "查看研究",
    ...
    researchBackedDescription:
      "我们的平台使用7个专业AI模型，训练于10,000+临床验证的舌象图像，结合这些同行评审研究的发现，提供准确的中医辨证识别。",
    viewDoi: "查看DOI",
  },
  ms: {
    ...
    subtitle:
      "Diagnosis lidah berkuasa AI kami berdasarkan penyelidikan yang disemak rakan setara dan bukti klinikal daripada kajian Perubatan Cina Tradisional.",
    researchBacked: "Pendekatan Berasaskan Penyelidikan",
    researchBackedDescription:
      "Platform kami menggunakan 7 model AI khusus yang dilatih pada 10,000+ imej lidah yang disahkan secara klinikal, menggabungkan penemuan daripada kajian yang disemak rakan setara ini untuk memberikan pengecaman corak TCM yang tepat.",
    viewDoi: "Lihat DOI",
  },
};
        ...
        <div className="overflow-y-auto flex-1 py-4 space-y-6 pr-2">
          {researchData.map((category) => (
            <div key={category.id} className="space-y-3">
              <div className="flex items-center gap-2 text-emerald-700 font-semibold">
                <div className="p-1.5 rounded-md bg-emerald-50">{category.icon}</div>
                ...
                {category.citations.map((citation, idx) => (
                  ...
                  >
                    <p className="text-sm text-stone-700 font-medium leading-relaxed">
                      ...
                      <span className="italic text-stone-500">{citation.journal}</span>.{" "}
                      {citation.year}.
                    </p>
                    <a
          ...
          <div className="mt-6 p-4 rounded-xl bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 border border-emerald-200/50">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-semibold text-emerald-800 mb-1">{t.researchBacked}</h4>
