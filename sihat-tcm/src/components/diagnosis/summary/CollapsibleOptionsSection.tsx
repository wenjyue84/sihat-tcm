    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          <div
            className={`w-8 h-8 shrink-0 rounded-full flex items-center justify-center ${iconBgColor}`}
          >
          ...
          <div className="flex flex-col items-start">
            ...
            {subtitle && (
              <span className="text-xs text-slate-500 hidden sm:inline-block">{subtitle}</span>
            )}
          </div>
        </div>
        {isExpanded ? (
