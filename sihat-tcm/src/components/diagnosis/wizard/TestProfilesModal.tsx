 ...
 */
export function TestProfilesModal({
    isOpen,
    onClose,
    onSelectProfile
}: TestProfilesModalProps) {
                    ...
                    {MOCK_PROFILES.map((profile: MockProfile) => (
                        ...
                        >
                            <div className="flex justify-between items-start mb-1">
                                ...
                                <span className="text-[10px] bg-slate-100 text-slate-500 px-2 py-0.5 rounded-full group-hover:bg-emerald-100 group-hover:text-emerald-600">Full Data</span>
                            </div>
