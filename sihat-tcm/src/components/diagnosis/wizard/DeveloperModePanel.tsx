...
export function DeveloperModePanel({
  ...
  return (
    <div
      className={`fixed bottom-4 right-4 z-50 bg-slate-800 text-white rounded-xl shadow-2xl border border-slate-700 transition-all duration-300 ${isMinimized ? "w-auto p-3" : "w-full max-w-xs p-4"} opacity-90 hover:opacity-100`}
    >
