        ...
        <div className="flex items-start gap-3 mb-4 p-3 bg-amber-100/70 rounded-lg border border-amber-300">
          ...
          <div>
            ...
            <p className="text-xs text-amber-600 mt-0.5">
              The pulse qualities below require assessment by a qualified TCM practitioner. General
              users may skip this section.
            </p>
          </div>
        </div>
