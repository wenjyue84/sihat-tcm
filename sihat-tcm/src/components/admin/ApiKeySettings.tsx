...
import { Key, Check, Loader2, AlertCircle, Eye, EyeOff, Trash2, Shield, CheckCircle2 } from 'lucide-react';
...
export function ApiKeySettings() {
    ...
    const handleClearKey = async () => {
        if (!confirm('Are you sure you want to remove the custom API key? The system will fall back to using the environment variable.')) {
            return;
        }
