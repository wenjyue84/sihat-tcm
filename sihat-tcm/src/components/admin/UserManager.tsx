...
export function UserManager() {
    ...
    const handleDelete = async (user: UserProfile) => {
        ...
        if (!confirm(`Are you sure you want to delete ${user.full_name || 'this patient'}? This action cannot be undone and will remove all their data including diagnosis history.`)) return
            ...
            <CardContent>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    ...
                    <div
                        ...
                        onClick={() => { setRoleFilter('patient'); setCurrentPage(1) }}
                    >
                        <div className="flex items-center gap-2 mb-1">
                ...
                <DialogContent className="max-w-2xl">
                    ...
                    {selectedUser && (
                        <div className="space-y-4 py-4">
                            <div className={`flex items-center gap-4 p-4 rounded-lg ${ROLE_CONFIG[selectedUser.role].bgColor}`}>
                                <div className={`w-16 h-16 rounded-full flex items-center justify-center ${ROLE_CONFIG[selectedUser.role].color.split(' ').slice(0, 2).join(' ')}`}>
                                    {(() => {
                                        const Icon = ROLE_CONFIG[selectedUser.role].icon
                                ...
                                <div>
                                    ...
                                    <Badge variant="outline" className={`mt-1 ${ROLE_CONFIG[selectedUser.role].color}`}>
                                ...
                                <>
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="p-3 border rounded-lg">
                                            ...
                                            <div className="font-semibold">{selectedUser.age ? `${selectedUser.age} years` : '-'}</div>
                                        </div>
                                        <div className="p-3 border rounded-lg">
                                        ...
                                        <div className="p-3 border rounded-lg">
                                            ...
                                            <div className="font-semibold">{selectedUser.height ? `${selectedUser.height} cm` : '-'}</div>
                                        </div>
                                        <div className="p-3 border rounded-lg">
                                            <div className="text-sm text-muted-foreground">Weight</div>
                                            <div className="font-semibold">{selectedUser.weight ? `${selectedUser.weight} kg` : '-'}</div>
                                        </div>
                            ...
                            <div className="text-xs text-muted-foreground text-center pt-2 border-t">
                                Last updated: {selectedUser.updated_at
