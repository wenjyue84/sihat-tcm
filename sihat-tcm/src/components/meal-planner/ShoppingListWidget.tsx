            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className="text-emerald-100 print:text-slate-600">
                  {checkedCount}/{totalItems} {t.patientDashboard.mealPlanner.itemsChecked} •{" "}
                  {normalizedList.length} {t.patientDashboard.mealPlanner.categories}
                </p>
              </div>
                    ...
                    {items.map((item: string, index: number) => {
                      ...
                      return (
                        <motion.button
                          ...
                          whileTap={{ scale: 0.99 }}
                          className={`flex items-center gap-3 p-3 rounded-lg border-2 transition-all text-left print:border print:p-2 ${
                            isChecked
