                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  {meal.temperature && (
                    <Badge className="bg-white/20 text-white hover:bg-white/30 text-xs">
                      ...
                      {temperatureEmojis[meal.temperature as keyof typeof temperatureEmojis]}{" "}
                      {meal.temperature}
                    </Badge>
                  )}
                </div>
          ...
          <div className="p-6 space-y-6">
                  ...
                  .map((step, index) => {
                    ...
                    if (match) {
                      return (
                        <div
                          key={index}
                          className="flex gap-3 mb-3 p-3 rounded-lg bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-100"
                        >
            ...
            {meal.notes && (
              <div className="p-4 rounded-lg bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-200">
                ...
                <p className="text-sm text-emerald-800 leading-relaxed">{meal.notes}</p>
              </div>
            )}
