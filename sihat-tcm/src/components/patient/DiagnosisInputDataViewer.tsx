      ...
      {session.tongue_analysis && (
        ...
        >
          <div className="p-4 space-y-4">
            ...
            {session.tongue_analysis.tcm_indicators &&
              session.tongue_analysis.tcm_indicators.length > 0 && (
                <div>
            ...
            {session.tongue_analysis.pattern_suggestions &&
              session.tongue_analysis.pattern_suggestions.length > 0 && (
                <div>
            ...
            {session.tongue_analysis.potential_issues &&
              session.tongue_analysis.potential_issues.length > 0 && (
                <div>
      ...
      {session.face_analysis && (
        ...
        >
          <div className="p-4 space-y-4">
            ...
            {session.face_analysis.tcm_indicators &&
              session.face_analysis.tcm_indicators.length > 0 && (
                <div>
                  <h4 className="font-medium mb-2 text-slate-700">TCM Indicators</h4>
                  <div className="flex flex-wrap gap-2">
            ...
            {session.face_analysis.potential_issues &&
              session.face_analysis.potential_issues.length > 0 && (
                <div>
                  <h4 className="font-medium mb-2 text-slate-700">Potential Issues</h4>
                  <ul className="list-disc list-inside space-y-1 text-sm text-slate-600">
      ...
      {session.body_analysis && (
        ...
        >
          <div className="p-4 space-y-4">
            ...
            {session.body_analysis.potential_issues &&
              session.body_analysis.potential_issues.length > 0 && (
                <div>
                  <h4 className="font-medium mb-2 text-slate-700">Potential Issues</h4>
                  <ul className="list-disc list-inside space-y-1 text-sm text-slate-600">
      ...
      {session.audio_analysis && (
        ...
        >
          <div className="p-4 space-y-4">
            ...
            {session.audio_analysis.potential_issues &&
              session.audio_analysis.potential_issues.length > 0 && (
                <div>
                  <h4 className="font-medium mb-2 text-slate-700">Potential Issues</h4>
                  <ul className="list-disc list-inside space-y-1 text-sm text-slate-600">
