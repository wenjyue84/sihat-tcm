...
export function SaveToDashboardBanner({
  isGuest,
  isSaved,
  onViewDashboard,
}: SaveToDashboardBannerProps) {
              ...
              <div className="flex flex-col md:flex-row items-start md:items-center gap-5 md:gap-6 pr-8">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-emerald-50 text-sm md:text-base mb-4 leading-relaxed">
                    Create a free account to save this report, visualize your health trends over
                    time, and build your personal TCM health passport.
                  </p>
