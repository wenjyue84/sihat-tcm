...
export function DailyTipCard({ constitutionType = '平和质' }: DailyTipCardProps): React.ReactElement {
            ...
            >
                ...
                <div className="relative p-5">
                    ...
                    <div className="flex items-start gap-4">
                        {/* Icon */}
                        <div className={`flex-shrink-0 w-12 h-12 rounded-xl flex items-center justify-center text-2xl bg-white/40 backdrop-blur-sm shadow-sm ${tip.type === 'diet' ? 'text-emerald-600' :
                            tip.type === 'exercise' ? 'text-blue-600' :
                                'text-amber-600'
                            }`}>
                            {tip.icon || getIcon()}
                        </div>
