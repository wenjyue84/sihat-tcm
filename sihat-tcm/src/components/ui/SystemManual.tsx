            ...
            steps: [
                {
                    ...
                    description: "Capture a clear photo of your tongue in good lighting. Our AI analyzes the coating, color, and shape.",
                    icon: <Camera className="w-5 h-5 text-emerald-600" />
                },
                {
                    title: "Face Analysis",
                    description: "Take a selfie of your face. We look for complexion and other facial indicators of your health.",
                    icon: <Camera className="w-5 h-5 text-emerald-600" />
                },
                {
                    title: "Health Questionnaire",
                    description: "Answer a few simple questions about your lifestyle and symptoms to refine the diagnosis.",
                    icon: <ClipboardList className="w-5 h-5 text-emerald-600" />
                },
                {
                    title: "Get Your Report",
                    description: "Receive a comprehensive TCM health report with personalized recommendations.",
            ...
            steps: [
                {
                    ...
                    description: "Ambil gambar lidah yang jelas dalam pencahayaan yang baik. AI kami menganalisis lapisan, warna, dan bentuk.",
                    icon: <Camera className="w-5 h-5 text-emerald-600" />
                },
                {
                    title: "Analisis Muka",
                    description: "Ambil swafoto muka anda. Kami melihat warna kulit dan penunjuk kesihatan muka yang lain.",
                    icon: <Camera className="w-5 h-5 text-emerald-600" />
                },
                {
                    title: "Soal Selidik Kesihatan",
                    description: "Jawab beberapa soalan mudah mengenai gaya hidup dan gejala anda untuk memperhalusi diagnosis.",
                    icon: <ClipboardList className="w-5 h-5 text-emerald-600" />
                },
                {
                    title: "Dapatkan Laporan",
                    description: "Terima laporan kesihatan TCM yang komprehensif dengan cadangan yang diperibadikan.",
                    icon: <Activity className="w-5 h-5 text-emerald-600" />
                }
            ]
        }
