...
export function ResponsiveWrapper({
  ...
  if (
    showOn &&
    !showOn.some(
      (bp) => responsive[`is${bp.charAt(0).toUpperCase() + bp.slice(1)}` as keyof typeof responsive]
    )
  ) {
    return <>{fallback}</>;
  }
  ...
  return <Component className={cn(platformClasses, className)}>{children}</Component>;
}
...
export function MobileOnly({
  ...
  return (
    <ResponsiveWrapper showOnDevice={["mobile"]} fallback={fallback} className={className}>
      {children}
    </ResponsiveWrapper>
  );
}
...
export function TabletOnly({
  ...
  return (
    <ResponsiveWrapper showOnDevice={["tablet"]} fallback={fallback} className={className}>
      {children}
    </ResponsiveWrapper>
  );
}
...
export function DesktopOnly({
  ...
  return (
    <ResponsiveWrapper showOnDevice={["desktop"]} fallback={fallback} className={className}>
      {children}
    </ResponsiveWrapper>
  );
}
...
export function TouchOnly({
  ...
  return (
    <ResponsiveWrapper requiresTouch={true} fallback={fallback} className={className}>
      {children}
    </ResponsiveWrapper>
  );
}

export function NonTouchOnly({
  children,
  fallback,
  className,
}: {
  ...
  return (
    <ResponsiveWrapper requiresTouch={false} fallback={fallback} className={className}>
      {children}
    </ResponsiveWrapper>
  );
}

export function IOSOnly({
  children,
  fallback,
  className,
}: {
  ...
  return (
    <ResponsiveWrapper showOnPlatform={["ios"]} fallback={fallback} className={className}>
      {children}
    </ResponsiveWrapper>
  );
}
...
export function AndroidOnly({
  ...
  return (
    <ResponsiveWrapper showOnPlatform={["android"]} fallback={fallback} className={className}>
      {children}
    </ResponsiveWrapper>
  );
}
...
export function WebOnly({
  ...
  return (
    <ResponsiveWrapper showOnPlatform={["web"]} fallback={fallback} className={className}>
      {children}
    </ResponsiveWrapper>
  );
}
...
export function PortraitOnly({
  ...
  return (
    <ResponsiveWrapper showOnOrientation={["portrait"]} fallback={fallback} className={className}>
      {children}
    </ResponsiveWrapper>
  );
}
...
export function LandscapeOnly({
  ...
  return (
    <ResponsiveWrapper showOnOrientation={["landscape"]} fallback={fallback} className={className}>
      {children}
    </ResponsiveWrapper>
  );
}
