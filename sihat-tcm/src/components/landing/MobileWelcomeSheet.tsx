...
export function MobileWelcomeSheet({ onDismiss }: MobileWelcomeSheetProps) {
    ...
    const welcomeTexts = {
        statusBadge: language === 'zh' ? 'AI诊断引擎已激活' : language === 'ms' ? 'Enjin Diagnostik AI Aktif' : 'AI Diagnostic Engine Active',
        title: language === 'zh' ? '您的私人' : language === 'ms' ? 'Doktor TCM' : 'Your Personal',
        titleHighlight: language === 'zh' ? '中医师' : language === 'ms' ? 'Peribadi Anda' : 'TCM Physician',
        ...
        stat1Label: language === 'zh' ? '平均时长' : language === 'ms' ? 'Purata Tempoh' : 'Avg. Duration',
        stat2Value: '95%',
        stat2Label: language === 'zh' ? '准确率' : language === 'ms' ? 'Ketepatan' : 'Accuracy',
        privacyNote: language === 'zh'
        ...
        ctaButton: language === 'zh' ? '开始问诊' : language === 'ms' ? 'Mulakan Konsultasi' : 'Start Consultation',
    }
                            ...
                            >
                                <div className="p-4 rounded-xl bg-slate-800/60 border border-slate-700/50 backdrop-blur-sm text-center">
                                    <div className="flex items-center justify-center gap-1.5 mb-1">
                                        ...
                                        <span className="text-xl font-bold text-emerald-400">{welcomeTexts.stat1Value}</span>
                                    </div>
                                ...
                                <div className="p-4 rounded-xl bg-slate-800/60 border border-slate-700/50 backdrop-blur-sm text-center">
                                    <div className="flex items-center justify-center gap-1.5 mb-1">
                                        ...
                                        <span className="text-xl font-bold text-emerald-400">{welcomeTexts.stat2Value}</span>
                                    </div>
                                    <div className="text-[10px] text-slate-400 uppercase tracking-wider font-medium">
