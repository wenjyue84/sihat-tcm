 ...
 */
export function getConstitutionDietTip(constitutionType: string): typeof CONSTITUTION_DIET_TIPS['平和质'][0] {
    const tips = CONSTITUTION_DIET_TIPS[constitutionType as keyof typeof CONSTITUTION_DIET_TIPS] || GENERAL_TIPS;
