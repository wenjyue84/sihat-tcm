    ...
    describe('testBPMCalculation', () => {
        ...
        it('should work across the normal heart rate range (50-180 BPM)', () => {
            ...
            testBpms.forEach(targetBpm => {
                ...
                // Log for debugging
                console.log(`Target: ${targetBpm}, Calculated: ${result.calculatedBpm}, Error: ${result.error}`)
...
describe('useCameraHeartRate Hook (Browser Environment)', () => {
    ...
    beforeEach(() => {
        ...
        Object.defineProperty(global.navigator, 'userAgent', {
            writable: true,
            value: 'Mozilla/5.0 (Linux; Android 11; Pixel 5) AppleWebKit/537.36 Chrome/91.0.4472.77 Mobile Safari/537.36',
        })
    })
    ...
    it('should detect iOS Safari as unsupported', () => {
        Object.defineProperty(global.navigator, 'userAgent', {
            writable: true,
            value: 'Mozilla/5.0 (iPhone; CPU iPhone OS 14_0 like Mac OS X) AppleWebKit/605.1.15 Mobile/15E148 Safari/604.1',
        })
