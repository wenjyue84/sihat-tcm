...
export async function PUT(request: NextRequest) {
    try {
        ...
        if (body.medicalHistorySummaryPrompt !== undefined) settingsToSave.medicalHistorySummaryPrompt = body.medicalHistorySummaryPrompt
        if (body.dietaryAdvicePrompt !== undefined) settingsToSave.dietaryAdvicePrompt = body.dietaryAdvicePrompt
        if (body.backgroundMusicEnabled !== undefined) settingsToSave.backgroundMusicEnabled = body.backgroundMusicEnabled
        if (body.backgroundMusicUrl !== undefined) settingsToSave.backgroundMusicUrl = body.backgroundMusicUrl
        if (body.backgroundMusicVolume !== undefined) settingsToSave.backgroundMusicVolume = body.backgroundMusicVolume
