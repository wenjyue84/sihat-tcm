...
export default function TestGeminiPage() {
    ...
    return (
        <div className="p-8 max-w-3xl mx-auto">
            ...
            <p className="text-sm text-gray-500 mb-4">Test different Gemini models to see which ones work with your API key.</p>
                    ...
                    {loading && (
                        <div className="mt-3 pt-3 border-t border-gray-600">
                            <p className="text-yellow-400 text-sm animate-pulse">
                                ⏱️ Elapsed: {Math.floor((Date.now() - Date.now()) / 1000)}s...
                                (Gemini models can take 10-60 seconds)
                            </p>
                        </div>
                    )}
                </div>
            ...
            <div className="mt-8 p-4 bg-gray-100 rounded">
                ...
                <ul className="text-sm text-gray-700 space-y-1">
                    <li><strong>Gemini 3 Pro Preview</strong> - Latest (Nov 2025), most advanced</li>
                    <li><strong>Gemini 2.5 Pro/Flash</strong> - Advanced reasoning, thinking models</li>
                    <li><strong>Gemini 2.0 Flash</strong> - Fast, agentic capabilities</li>
                    <li><strong>Gemini 1.5 Pro/Flash</strong> - Stable, large context window</li>
                </ul>
            </div>
        </div>
    );
