...
const blogTranslations = {
    en: {
        ...
        description: 'Discover the wisdom of Traditional Chinese Medicine combined with modern AI diagnostics. Articles, guides, and tips for your wellness journey.',
    ...
    ms: {
        ...
        description: 'Temui kebijaksanaan Perubatan Tradisional Cina yang digabungkan dengan diagnostik AI moden. Artikel, panduan, dan tips untuk kesihatan anda.',
...
export default async function BlogIndex(props: Props) {
    ...
    if (query) {
        ...
        const allPosts = getAllPosts(['title', 'date', 'slug', 'author', 'coverImage', 'excerpt', 'readingTime'], lang);
        ...
        <div className="min-h-screen bg-stone-50/50 pb-20">
            ...
            <section className="bg-white border-b border-stone-100 py-20">
                <div className="container px-4 mx-auto text-center relative">
                    ...
                    <Badge variant="outline" className="mb-4 text-emerald-700 border-emerald-200 bg-emerald-50">{t.badge}</Badge>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Button asChild variant="outline" className="border-stone-300 text-stone-600 hover:text-stone-900 hover:bg-stone-50">
                            <Link href="/">
                                <Home className="mr-2 w-4 h-4" />
                                {t.backToHome}
                            </Link>
                        </Button>
                        <Button asChild className="bg-emerald-700 hover:bg-emerald-800 text-white shadow-lg hover:shadow-emerald-900/20">
                            <Link href="/">
                                {t.promoButton}
                        ...
                        {posts.map((post) => (
                            <Card key={post.slug} className="group hover:shadow-lg transition-all duration-300 border-stone-200 bg-white overflow-hidden flex flex-col h-full">
                                ...
                                <CardHeader>
                                    ...
                                    <Link href={`/blog/${post.slug}${lang !== 'en' ? `?lang=${lang}` : ''}`} className="hover:text-emerald-700 transition-colors">
