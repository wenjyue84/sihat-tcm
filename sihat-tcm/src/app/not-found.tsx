  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center px-4 py-16 bg-gradient-to-b from-background via-background to-muted/30">
      ...
      <div className="relative z-10 text-center max-w-2xl mx-auto">
        ...
        <div
          id="tina-admin-hint"
          className="hidden mb-8 p-6 bg-amber-50 border border-amber-200 rounded-xl text-left animate-in fade-in slide-in-from-top-4 duration-700"
        >
          ...
          <p className="text-amber-700 text-sm mb-4">
            It looks like you&apos;re trying to access the blog editor. If you see this 404 page, it
            usually means the Tina CMS engine is not running.
          </p>
          <div className="bg-amber-100/50 p-3 rounded-lg border border-amber-200/50">
            <p className="text-xs font-mono text-amber-900 mb-2">
              To fix this, stop your current server and run:
            </p>
        ...
        <p className="text-muted-foreground text-lg mb-8 max-w-md mx-auto">
          Oops! The page you&apos;re looking for seems to have wandered off the path. It might have
