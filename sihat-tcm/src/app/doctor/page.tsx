...
import { LogOut, Search, Calendar, User, Stethoscope, FileText, X, Users, Activity, Clock, Filter } from 'lucide-react'
            ...
            <div className="container mx-auto p-6 max-w-6xl">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                    <div className="text-center md:text-left">
                        ...
                        <p className="text-gray-500 mt-1">Patient History & Records Management</p>
                    </div>
                    <Button
                        variant="outline"
