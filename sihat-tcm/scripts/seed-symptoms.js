...
const symptomMappings = {
    'Yin Deficiency': ['Night sweats', 'Insomnia', 'Dry mouth', 'Hot palms and soles', 'Restlessness'],
    'Yang Deficiency': ['Cold extremities', 'Lower back pain', 'Fatigue', 'Frequent urination', 'Weakness'],
    'Qi Deficiency': ['Fatigue', 'Shortness of breath', 'Weak voice', 'Spontaneous sweating', 'Poor appetite'],
    ...
    'Damp Heat': ['Heavy feeling', 'Sticky mouth', 'Yellow discharge', 'Bitter taste', 'Urinary discomfort'],
...
async function createMockSessions() {
    ...
    const mockSessions = [
        ...
        },
        {
            ...
            overall_score: 58,
            symptoms: ['Extreme fatigue', 'Brain fog', 'Muscle weakness', 'Sleep disturbances', 'Poor concentration'],
        ...
        },
        {
            ...
            overall_score: 62,
            symptoms: ['Bloating after meals', 'Loose stools', 'Feeling of heaviness', 'Poor digestion', 'Loss of appetite'],
