...
console.log(
  "This script will disable the need for email confirmation by auto-confirming all users."
);
...
console.log(
  "Find it here: Supabase Dashboard -> Project Settings -> Database -> Connection String -> Node.js\n"
);
