...
const supabaseServiceKey = process.env.SUPABASE_SERVICE_ROLE_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImtpeHFtcXV3cXp2Y3ZkdmZuZmFyIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczNDI2MDU1NywiZXhwIjoyMDQ5ODM2NTU3fQ.Jdnp7KTlQa2KVGmNkLRBEhtJPQ5jvQPxGxKaBZM0bSw';
...
async function executeSQL() {
    try {
        ...
        const sqlContent = readFileSync(join(__dirname, 'supabase', 'seed_yeak_patient_data.sql'), 'utf-8');
...
✅ Paracetamol/acetaminophen ONLY for pain relief`,
                ...
                notes: 'Comprehensive medical history imported from family health records. Patient showing significant improvement after implementation of strict dietary control and environmental adjustments on December 10, 2025.',
