...
import { STEPS_CONFIG } from "./diagnosis/diagnosisConstants";
import type { DiagnosisStep, AnalysisType } from "./diagnosis/diagnosisTypes";
import { useDiagnosisResume } from "./diagnosis/useDiagnosisResume";
import { useDiagnosisProgressTracking } from "./diagnosis/useDiagnosisProgressTracking";
import { useDiagnosisNavigation } from "./diagnosis/useDiagnosisNavigation";
import { useDiagnosisImageAnalysis } from "./diagnosis/useDiagnosisImageAnalysis";
import { useDiagnosisSubmission } from "./diagnosis/useDiagnosisSubmission";

// Re-export types and utilities for backward compatibility
export type { DiagnosisStep, AnalysisType };
export { STEPS_CONFIG };
export { repairJSON, generateMockReport } from "./diagnosis/diagnosisUtils";
...
export function useDiagnosisWizard() {
  ...
  const submissionHook = useDiagnosisSubmission({ data });
