/**
 * Solar Terms Data (24 节气)
 *
 * Static data definitions for TCM solar terms.
 * This file contains ONLY data - utility functions are in @/lib/domain/tcm/solar-terms.ts
 */
...
export const SOLAR_TERMS_DATA: SolarTermData[] = [
  {
