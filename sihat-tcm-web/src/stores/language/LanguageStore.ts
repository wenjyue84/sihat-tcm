...
import { LanguageStore, STORAGE_KEYS } from "../interfaces/StoreInterfaces";
    ...
    initializeLanguage: () => {
      ...
      if (typeof window !== "undefined") {
        ...
        if (savedLanguage && ["en", "zh", "ms"].includes(savedLanguage)) {
          ...
          const langCode =
            savedLanguage === "zh" ? "zh-CN" : savedLanguage === "ms" ? "ms-MY" : "en";
          document.documentElement.lang = langCode;

          logger.info("LanguageStore", "Language loaded from localStorage", {
          ...
          const langCode =
            browserLanguage === "zh" ? "zh-CN" : browserLanguage === "ms" ? "ms-MY" : "en";
          document.documentElement.lang = langCode;

          logger.info("LanguageStore", "Language set to browser default", {
