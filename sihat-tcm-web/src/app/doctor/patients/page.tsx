...
export default function PatientsPage() {
    ...
    const [selectedTypes, setSelectedTypes] = useState<PatientType[]>(['managed', 'registered', 'guest']);
                                ...
                                <DropdownMenuContent align="end" className="w-56">
                                    ...
                                    <DropdownMenuItem onClick={(e) => {
                                        ...
                                        <div className="flex items-center gap-2 w-full">
                                            <div className={`w-4 h-4 border rounded flex items-center justify-center ${selectedTypes.includes('managed') ? 'bg-blue-600 border-blue-600 text-white' : 'border-slate-300'}`}>
                                    ...
                                    <DropdownMenuItem onClick={(e) => {
                                        ...
                                        <div className="flex items-center gap-2 w-full">
                                            <div className={`w-4 h-4 border rounded flex items-center justify-center ${selectedTypes.includes('registered') ? 'bg-blue-600 border-blue-600 text-white' : 'border-slate-300'}`}>
                                                {selectedTypes.includes('registered') && <ShieldCheck className="w-3 h-3" />}
                                            </div>
                                    ...
                                    <DropdownMenuItem onClick={(e) => {
                                        ...
                                        <div className="flex items-center gap-2 w-full">
                                            <div className={`w-4 h-4 border rounded flex items-center justify-center ${selectedTypes.includes('guest') ? 'bg-blue-600 border-blue-600 text-white' : 'border-slate-300'}`}>
                                    ...
                                    <DropdownMenuSeparator />
                                    <DropdownMenuItem onClick={() => setSelectedTypes(['managed', 'registered', 'guest'])} className="text-center justify-center text-blue-600">
                                        Reset Filters
                                    </DropdownMenuItem>
                                </DropdownMenuContent>
                            </DropdownMenu>
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4">
                        <Tabs defaultValue="all" className="w-[400px]" onValueChange={setActiveTab}>
                            <TabsList className="bg-white border border-slate-200">
                                ...
                                <TabsTrigger value="managed" className="data-[state=active]:bg-blue-50 data-[state=active]:text-blue-600">Managed</TabsTrigger>
                                <TabsTrigger value="registered" className="data-[state=active]:bg-blue-50 data-[state=active]:text-blue-600">Registered</TabsTrigger>
                                <TabsTrigger value="guest" className="data-[state=active]:bg-blue-50 data-[state=active]:text-blue-600">Guest</TabsTrigger>
                                <TabsTrigger value="critical" className="data-[state=active]:bg-red-50 data-[state=active]:text-red-600">Critical</TabsTrigger>
                            </TabsList>
                        </Tabs>
                                ...
                                <table className="w-full text-left">
                                    <thead>
                                        <tr className="bg-slate-50/50 border-b border-slate-200">
                                            ...
                                            <th className="px-6 py-4 text-xs font-semibold text-slate-500 uppercase tracking-wider">Clinical Status</th>
                                            <th className="px-6 py-4 text-xs font-semibold text-slate-500 uppercase tracking-wider">Account Type</th>
                                                ...
                                                <tr key={patient.id} className="hover:bg-slate-50/80 transition-all group">
                                                    ...
                                                    <td className="px-6 py-4">
                                                        <div className="flex flex-col gap-2">
                                                            ...
                                                            />
                                                            <Badge variant="outline" className="w-fit text-[10px] uppercase border-slate-200 text-slate-500">
                                                                {patient.status}
                                                            </Badge>
                                                        </div>
                                                    </td>
                                                    <td className="px-6 py-4">
                                                        <Badge
                                                            variant={patient.type === 'registered' ? 'default' : patient.type === 'managed' ? 'secondary' : 'outline'}
                                                            className={
                                                        ...
                                                        >
                                                            {patient.type === 'registered' ? 'Self-registered' : patient.type === 'managed' ? 'Doctor-managed' : 'Guest'}
                                                        </Badge>
                                                    </td>
                                                    <td className="px-6 py-4">
                                                    ...
                                                    <td className="px-6 py-4 text-right">
                                                        <div className="flex items-center justify-end gap-2">
                                                            ...
                                                            >
                                                                <Link href={`/doctor/diagnose?patientId=${patient.id}`}>
                                                            ...
                                                            <DropdownMenu>
                                                                ...
                                                                <DropdownMenuContent align="end" className="w-48">
                                                                    ...
                                                                    {patient.type === 'managed' && (
                                                                        <DropdownMenuItem onClick={() => handleInvite(patient.id)} className="text-blue-600 focus:text-blue-700 cursor-pointer">
