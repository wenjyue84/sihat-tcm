...
import type { FilterStatus, SortOption, ConversationItemData } from "@/components/doctor/communication";
...
export default function DoctorCommunicationPage() {
    ...
    const fetchRequests = async () => {
        try {
            ...
            // Combine and sort
            const allRequests = [...sessionsRequests, ...inquiriesRequests].sort((a, b) =>
                                ...
                                {activeRequest.messages.length === 0 ? (
                                    ...
                                    >
                                        ...
                                        <p className="text-blue-700 text-sm mt-2 px-6">
                                            This patient is requesting verification for their AI diagnosis.
                                            Reply to approve and start a conversation.
                                        </p>
                                    </motion.div>
                                ) : (
