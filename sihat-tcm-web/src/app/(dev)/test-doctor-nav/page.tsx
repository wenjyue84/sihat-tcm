...
const testNavItems: NavItem[] = [
    { id: "dashboard", label: "Dashboard", icon: <LayoutDashboard className="w-4 h-4" />, section: "Practice" },
    ...
    { id: "schedule", label: "Schedule", icon: <Calendar className="w-4 h-4" />, section: "Clinical" },
    { id: "communication", label: "Communication", icon: <MessageSquare className="w-4 h-4" />, section: "Communication" },
    { id: "settings", label: "Settings", icon: <Settings className="w-4 h-4" />, section: "Settings" },
];
...
export default function TestDoctorNavPage() {
    ...
    const sections = testNavItems.reduce((acc, item) => {
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200 space-y-6">
                        ...
                        <section>
                            ...
                            <p className="text-sm text-slate-600">
                                Toggle device toolbar (Ctrl+Shift+M) to test touch behavior.
                                Tap items should show scale-down feedback without hover artifacts.
                            </p>
                        </section>
                    </div>
                </div>
