...
const mockInquiry: Inquiry = {
    ...
    symptoms: "Patient reports persistent headaches, fatigue, and occasional dizziness. Symptoms worsen in the afternoon.",
    diagnosis_report: {
            ...
            <div className="max-w-4xl mx-auto px-4">
                ...
                <section className="mb-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <p className="text-xs text-slate-500 mb-2">Report variant (with View Full Report button):</p>
                            <InquiryCard
                                inquiry={mockInquiry}
                                variant="report"
                            />
