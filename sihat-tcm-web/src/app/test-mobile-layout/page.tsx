...
export default function TestMobileLayoutPage() {
  ...
  return (
    <div className="min-h-screen bg-stone-50 py-8">
      ...
      <div
        className={`w-full px-5 md:px-6 md:max-w-4xl md:mx-auto space-y-8 ${
          viewport === "mobile"
            ? "max-w-full"
            : viewport === "tablet"
              ? "max-w-2xl mx-auto"
      ...
      >
        ...
        <Card className="p-5 md:p-6">
          ...
          <p className="text-xs text-stone-500 mt-4">
            ✅ This card uses full width on mobile (w-full). Grid adapts: 2 columns on mobile, 4 on
            desktop.
          </p>
        </Card>
        ...
        <Card className="p-5 md:p-6">
          ...
          <div className="w-[90%] max-w-[680px] mx-auto">
            <p className="text-base md:text-lg text-stone-800 leading-relaxed">{mockTextContent}</p>
          </div>
          <p className="text-xs text-stone-500 mt-4 text-center">
            ✅ This text uses w-[90%] max-w-[680px] for optimal reading width (45-75 characters per
            line).
          </p>
        </Card>
        ...
        <div className="space-y-4">
          ...
          <Card className="p-5 md:p-6 max-w-4xl mx-auto border-2 border-red-200 bg-red-50/30">
            <h3 className="font-semibold text-red-800 mb-2">
              ❌ Old Pattern (max-w-4xl on mobile)
            </h3>
            <p className="text-sm text-red-700">
              This container uses max-w-4xl even on mobile, wasting horizontal space. On a 375px
              device, this would be constrained to ~343px, wasting ~32px.
            </p>
          </Card>
          ...
          <Card className="p-5 md:p-6 w-full md:max-w-4xl md:mx-auto border-2 border-emerald-200 bg-emerald-50/30">
            <h3 className="font-semibold text-emerald-800 mb-2">
              ✅ New Pattern (w-full on mobile)
            </h3>
            <p className="text-sm text-emerald-700">
              This container uses full width on mobile (w-full px-5), then constrains on desktop
              (md:max-w-4xl). On a 375px device, this uses ~335px (375px - 40px padding), maximizing
              space usage.
            </p>
          </Card>
        </div>
        ...
        <Card className="p-5 md:p-6">
          <h2 className="text-lg font-semibold text-emerald-800 mb-4">Test 4: Padding Strategy</h2>
          <div className="space-y-2 text-sm">
            <p>
              <strong>Mobile:</strong> px-5 (20px horizontal padding)
            </p>
            <p>
              <strong>Desktop:</strong> md:px-6 (24px horizontal padding)
            </p>
        ...
        <Card className="p-5 md:p-6 bg-blue-50 border-blue-200">
          <h2 className="text-lg font-semibold text-blue-800 mb-4">📏 Measurement Guide</h2>
          <div className="space-y-2 text-sm text-blue-700">
            <p>
              <strong>iPhone SE (375px):</strong>
            </p>
            ...
            <p className="mt-3">
              <strong>iPhone 14 Pro Max (428px):</strong>
            </p>
            <ul className="list-disc list-inside ml-4 space-y-1">
