  ...
  const mobileExclusiveFeatures = [
    {
      ...
      description:
        t.mobileFeatures?.cameraPPG?.description ||
    ...
    },
    {
      ...
      description:
        t.mobileFeatures?.healthAppSync?.description ||
    ...
    },
    {
      ...
      description:
        t.mobileFeatures?.biometricAuth?.description ||
    ...
    },
    {
      ...
      description:
        t.mobileFeatures?.offlineMode?.description ||
    ...
    },
    {
      ...
      description:
        t.mobileFeatures?.pushNotifications?.description ||
    ...
    },
    {
      ...
      description:
        t.mobileFeatures?.wearableIntegration?.description ||
    ...
    },
    {
      ...
      description:
        t.mobileFeatures?.enhancedCamera?.description ||
    ...
    },
    {
      ...
      description:
        t.mobileFeatures?.hapticFeedback?.description ||
  ...
  const webAvailableFeatures = [
    {
      ...
      description:
        t.mobileFeatures?.diagnosis?.description ||
        "AI-powered TCM diagnosis using Observation, Listening, Inquiry, and Pulse examination methods. Enhanced on mobile with better camera and audio capture.",
      image:
        "https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?w=800&h=600&fit=crop&q=80",
      gradient: "from-emerald-500 to-teal-600",
    },
    {
      ...
      description:
        t.mobileFeatures?.snoreAnalysis?.description ||
        "AI-powered sleep sound recording and analysis for snoring and sleep apnea indicators. Optimized for mobile with better audio capture.",
      image:
        "https://images.unsplash.com/photo-1541781774459-bb2af2f05b55?w=800&h=600&fit=crop&q=80",
    ...
    },
    {
      ...
      description:
        t.mobileFeatures?.mealPlanner?.description ||
    ...
    },
    {
      ...
      description:
        t.mobileFeatures?.healthTracking?.description ||
    ...
    },
    {
      ...
      description:
        t.mobileFeatures?.vitalityRhythm?.description ||
    ...
    },
    {
      ...
      description:
        t.mobileFeatures?.qiDose?.description ||
    ...
    },
    {
      id: "community",
      icon: Users,
      title: t.patientDashboard_v1?.tabs?.community || "Healing Garden",
      description:
        t.healingGarden?.subtitle ||
    ...
    },
    {
      ...
      description:
        t.mobileFeatures?.familyCare?.description ||
    ...
    },
    {
      ...
      description:
        t.mobileFeatures?.herbShop?.description ||
    ...
    },
    {
      ...
      description:
        t.mobileFeatures?.digitalTwin?.description ||
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-emerald-100 mb-8 max-w-2xl mx-auto">
              {t.mobileFeatures?.heroDescription ||
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-stone-600 max-w-2xl mx-auto">
            {t.mobileFeatures?.exclusiveFeaturesSubtitle ||
          ...
          {mobileExclusiveFeatures.map((feature, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Content */}
                <div className="p-6">
                  <h4 className="text-xl font-bold text-stone-800 mb-2">{feature.title}</h4>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-base text-stone-600 max-w-2xl mx-auto">
              {t.mobileFeatures?.webFeaturesSubtitle ||
              ...
              return (
                ...
                >
                  ...
                  <div className="relative h-40 overflow-hidden">
                    ...
                    />
                    <div
                      className={`absolute inset-0 bg-gradient-to-t ${feature.gradient} opacity-70`}
                    ></div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-emerald-200 mb-8">
              {t.mobileFeatures?.ctaDescription ||
              ...
              >
                <div className="flex flex-col items-start leading-none gap-0.5">
                  <span className="text-[10px] uppercase tracking-wider opacity-80">
                    {t.appDownload.directDownload || "Direct Download"}
                  </span>
