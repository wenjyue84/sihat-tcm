...
const DoctorIcon = () => (
  <svg viewBox="0 0 24 24" className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="1.5">
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19 14.5M14.25 3.104c.251.023.501.05.75.082M19 14.5l-1.5 6.5H6.5L5 14.5m14 0l-4.5-4.091m-9 4.091L10 10.409"
    />
  </svg>
);
    ...
    <div className="min-h-screen bg-gradient-to-b from-stone-50 to-stone-100 flex items-center justify-center p-4">
              ...
              <div className="relative z-10">
                ...
                <ul className="space-y-6">
                  <li className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-medium text-lg text-emerald-50">
                        {t.login.benefits.saveProfile}
                      </h4>
                  ...
                  <li className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-medium text-lg text-emerald-50">
                        {t.login.benefits.saveReports}
                      </h4>
                      <p className="text-emerald-200/80 text-sm">
                        Access your previous diagnosis results.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-medium text-lg text-emerald-50">
                        {t.login.benefits.trackProgress}
                      </h4>
                      <p className="text-emerald-200/80 text-sm">
      ...
      <Dialog open={showGuestWarning} onOpenChange={setShowGuestWarning}>
        <DialogContent>
          ...
          <DialogFooter>
            <Button variant="outline" onClick={handleGuestWarningCancel}>
