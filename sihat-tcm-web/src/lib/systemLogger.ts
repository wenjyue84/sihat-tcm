 ...
 * 
 * For client components, use: import { devLog } from "@/lib/systemLogger.client"
 */

import { createClient } from "@/lib/supabase/server";

// Re-export devLog from client-safe module for backward compatibility
export { devLog } from "@/lib/systemLogger.client";
export type { LogLevel } from "@/lib/systemLogger.client";
