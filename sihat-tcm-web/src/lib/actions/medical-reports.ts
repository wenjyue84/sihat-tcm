...
export async function saveMedicalReport(
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : "Failed to save medical report",
    };
  }
}
...
export async function deleteMedicalReport(reportId: string): Promise<ActionResult> {
  try {
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : "Failed to delete medical report",
    };
  }
}
...
export async function seedMedicalReports(): Promise<ActionResult> {
  try {
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : "Failed to seed reports",
    };
  }
}
