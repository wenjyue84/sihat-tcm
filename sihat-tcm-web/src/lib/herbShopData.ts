...
export const HERBAL_PRODUCTS: Record<string, HerbalProduct> = {
  si_jun_zi_tang: {
    ...
    description:
      "The foundational formula for tonifying Spleen Qi. Ideal for general fatigue, weak digestion, and low energy.",
    descriptionZh: "补脾益气的基础方剂。适用于一般疲劳、消化不良和精力不足。",
    descriptionMs:
      "Formula asas untuk mengukuhkan Qi Limpa. Sesuai untuk keletihan umum, pencernaan lemah, dan tenaga rendah.",
  ...
  liu_jun_zi_tang: {
    ...
    description:
      "Enhanced version of Four Gentlemen with added herbs to address phlegm and dampness. Perfect for those with digestive issues accompanied by bloating.",
    descriptionZh: "四君子汤的加强版，增加了化痰祛湿的药物。适合消化不良伴有腹胀的患者。",
    descriptionMs:
      "Versi dipertingkatkan Empat Gentleman dengan herba tambahan untuk menangani kahak dan lembapan.",
  ...
  bu_zhong_yi_qi_tang: {
    ...
    description:
      "A powerful formula for raising sunken Qi and combating chronic fatigue. Excellent for those who feel constantly tired and weak.",
    descriptionZh: "提升中气、对抗慢性疲劳的强效方剂。适合经常感到疲倦无力的人群。",
    descriptionMs:
      "Formula berkuasa untuk meningkatkan Qi yang lemah dan memerangi keletihan kronik.",
  ...
  liu_wei_di_huang_wan: {
    ...
    description:
      "The classic formula for nourishing Kidney Yin. Addresses symptoms like night sweats, hot flashes, and lower back weakness.",
    descriptionZh: "滋肾阴的经典方剂。适用于盗汗、潮热、腰膝酸软等症状。",
    descriptionMs:
      "Formula klasik untuk menyuburkan Yin Buah Pinggang. Menangani gejala seperti peluh malam dan kelemahan pinggang.",
  ...
  si_wu_tang: {
    ...
    description:
      "The foundational blood-nourishing formula, especially beneficial for women. Addresses blood deficiency symptoms like pale complexion and irregular menstruation.",
  ...
  xiao_yao_san: {
    ...
    description:
      "The go-to formula for Liver Qi stagnation with Spleen deficiency. Perfect for stress, mood swings, and digestive issues.",
    descriptionZh: "治疗肝郁脾虚的首选方剂。适用于压力、情绪波动和消化问题。",
    descriptionMs:
      "Formula utama untuk stagnasi Qi Hati dengan kekurangan Limpa. Sesuai untuk tekanan dan masalah pencernaan.",
  ...
  jin_gui_shen_qi_wan: {
    ...
    description:
      "Warms and tonifies Kidney Yang. Ideal for cold extremities, frequent urination at night, and lower back coldness.",
    descriptionZh: "温补肾阳。适用于四肢冰冷、夜尿频多、腰部畏寒等症状。",
    descriptionMs:
      "Menghangatkan dan menguatkan Yang Buah Pinggang. Sesuai untuk anggota badan sejuk dan kerap kencing malam.",
    indications: [
  ...
  gui_pi_tang: {
    ...
    description:
      "Tonifies both Qi and Blood while calming the spirit. Excellent for insomnia, anxiety, and overthinking with fatigue.",
    descriptionZh: "补气血、安神志。适用于失眠、焦虑、思虑过度伴疲劳。",
    descriptionMs:
      "Menguatkan Qi dan Darah sambil menenangkan jiwa. Sangat baik untuk insomnia dan kebimbangan.",
  ...
  er_chen_tang: {
    ...
    description:
      "The foundational formula for resolving phlegm-dampness. Ideal for chronic cough with phlegm, chest congestion, and nausea.",
    descriptionZh: "化痰祛湿的基础方剂。适用于慢性咳嗽有痰、胸闷、恶心等症状。",
    descriptionMs:
      "Formula asas untuk menyelesaikan kahak-lembapan. Sesuai untuk batuk kronik dengan kahak.",
  ...
  bao_he_wan: {
    ...
    description:
      "Relieves food stagnation and promotes digestion. Perfect after overeating or for chronic indigestion.",
    descriptionZh: "消食导滞、促进消化。适用于暴饮暴食后或慢性消化不良。",
    descriptionMs:
      "Melegakan kesesakan makanan dan menggalakkan pencernaan. Sesuai selepas makan berlebihan.",
