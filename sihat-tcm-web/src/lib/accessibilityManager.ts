...
export type { AccessibilityPreferences, FocusableElement, AccessibilityAnnouncement };
...
export class AccessibilityManager {
  ...
  constructor(_initialPreferences?: Partial<AccessibilityPreferences>) {
    console.warn(
      "[AccessibilityManager] Using deprecated API. Please migrate to the new modular system."
    );
...
export function updateAccessibilityPreferences(
  ...
  console.warn(
    "[updateAccessibilityPreferences] Using deprecated API. Please migrate to the new modular system."
  );
...
export function registerFocusGroup(
  ...
  console.warn(
    "[registerFocusGroup] Using deprecated API. Please migrate to the new modular system."
  );
...
export function addAriaAttributes(element: HTMLElement, attributes: Record<string, string>): void {
  console.warn(
    "[addAriaAttributes] Using deprecated API. Please migrate to the new modular system."
  );
  Object.entries(attributes).forEach(([key, value]) => {
    element.setAttribute(key.startsWith("aria-") ? key : `aria-${key}`, value);
  });
...
export function validateColorContrast(
  ...
  console.warn(
    "[validateColorContrast] Using deprecated API. Please migrate to the new modular system."
  );
