...
export function getPromptSummaries() {
  return {
    ...
    western_doctor: {
      ...
      description: "Provides complementary Western medicine perspective after TCM diagnosis",
      keyPoints: [
    ...
    heart_companion: {
      ...
      description: "Emotional wellness support through TCM perspective on mental health",
      keyPoints: [
    ...
    meal_planner: {
      ...
      description: "Personalized 7-day TCM meal planning based on constitution",
      keyPoints: [
