...
export class VoiceCommandHandler {
  ...
  constructor(options: Partial<VoiceCommandHandlerOptions> = {}) {
    console.warn(
      "[VoiceCommandHandler] Using deprecated API. Please migrate to the new modular system."
    );
...
export function getVoiceCommandHandler(
  ...
  console.warn(
    "[getVoiceCommandHandler] Using deprecated API. Please migrate to the new modular system."
  );
...
export function checkVoiceSupport(): VoiceSupportInfo {
  console.warn(
    "[checkVoiceSupport] Using deprecated API. Please migrate to the new modular system."
  );
