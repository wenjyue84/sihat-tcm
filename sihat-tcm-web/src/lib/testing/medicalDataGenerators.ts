...
export const patientProfileArbitrary = fc
  .record({
    id: fc.uuid(),
...
export const healthTimeSeriesArbitrary = fc.record({
  ...
  value: fc.oneof(fc.float({ min: 0, max: 1000 }), fc.integer({ min: 0, max: 1000 }), fc.string()),
