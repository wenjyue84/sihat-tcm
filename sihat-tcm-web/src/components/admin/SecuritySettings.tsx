    ...
    <div className="space-y-6">
      ...
      <Card className="border-slate-200 bg-gradient-to-br from-slate-50 to-white">
        <CardHeader>
          ...
          <CardDescription>
            Protect your Gemini API from abuse by configuring rate limits and authentication
            ...
            >
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  ...
                  {isSelected && (
                    <span
                      className={`text-xs font-medium px-2 py-1 rounded-full ${colors.bg} ${colors.icon}`}
                    >
                      Active
                    </span>
                  )}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Customize the rate limits for Level {config.level}. Leave at defaults for recommended
            settings.
          </CardDescription>
        </CardHeader>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => {
                  setConfig((prev) => ({
                    ...prev,
                    rateLimitPerMinute: parseInt(e.target.value) || 1,
                  }));
                  setCustomLimits(true);
                }}
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => {
                  setConfig((prev) => ({
                    ...prev,
                    rateLimitPerDay: parseInt(e.target.value) || 1,
                  }));
                  setCustomLimits(true);
                }}
                className="max-w-[200px]"
        ...
        <CardContent>
          <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-4">
            <div className="flex items-center gap-2 p-3 bg-slate-50 rounded-lg">
              <Shield
                className={`w-5 h-5 ${colorClasses[LEVEL_INFO[config.level].color as keyof typeof colorClasses].icon}`}
              />
              <div>
            ...
            <div className="flex items-center gap-2 p-3 bg-slate-50 rounded-lg">
              <Lock
                className={`w-5 h-5 ${config.requireAuth ? "text-emerald-500" : "text-slate-400"}`}
              />
              <div>
            ...
            <div className="flex items-center gap-2 p-3 bg-slate-50 rounded-lg">
              <UserCheck
                className={`w-5 h-5 ${config.trackPerUser ? "text-emerald-500" : "text-slate-400"}`}
              />
              <div>
        ...
        <CardContent>
          <div className="flex flex-wrap gap-2">
            {[
              ...
              <code key={route} className="text-xs bg-slate-100 px-2 py-1 rounded font-mono">
                {route}
              </code>
            ))}
          </div>
