...
export function PatientManager() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (editingId) {
        const { error } = await supabase.from("profiles").update(dataToSave).eq("id", editingId);
              ...
              <div className="flex items-center gap-4 p-4 bg-emerald-50 rounded-lg">
                ...
                <div>
                  <h3 className="text-xl font-semibold">
                    {viewingPatient.full_name || "Unnamed Patient"}
                  </h3>
                  <p className="text-sm text-muted-foreground">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-3 border rounded-lg">
                  ...
                  <div className="font-semibold">
                    {viewingPatient.height ? `${viewingPatient.height} cm` : "-"}
                  </div>
                </div>
                <div className="p-3 border rounded-lg">
                  <div className="text-sm text-muted-foreground">Weight</div>
                  <div className="font-semibold">
                    {viewingPatient.weight ? `${viewingPatient.weight} kg` : "-"}
                  </div>
                </div>
