...
const DEFAULT_PRACTITIONERS = [
  ...
  },
  {
    ...
    notes:
      "Established since 1989, very well-known JB brand with multiple TCM services and online presence.",
  },
  {
    ...
    notes:
      "Evolved from Yew Kok Ann TCM (since ~1950), focuses on rehabilitation and long-term wellness.",
  },
  {
    ...
    address:
      "Southern TCM Centre, TCM Building, Southern University College, PTD 64888, 15KM Jalan Skudai, 81300 Skudai, Johor",
    phone: "07‑554 1795 / 07‑558 6605",
    working_hours: "Mon–Fri 9:00 am – 5:00 pm",
    experience: "University Centre",
    notes:
      "Well-known teaching and service centre in Skudai with multiple TCM specialties and community services.",
  },
  {
    ...
    experience: ">30 years",
    notes:
      "Frequently listed among JB’s recommended acupuncture spots; principal physician with >30 years’ TCM experience.",
  },
  {
...
export function PractitionerManager() {
  ...
  const handleSeedPractitioners = async () => {
    ...
    try {
      ...
      const newPractitioners = DEFAULT_PRACTITIONERS.filter(
        (p) => !practitioners.some((existing) => existing.name === p.name)
      );
    ...
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        <div>
          ...
          <CardDescription>
            Manage the list of TCM doctors and clinics displayed in reports
          </CardDescription>
        </div>
