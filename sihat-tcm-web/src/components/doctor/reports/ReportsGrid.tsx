 ...
 */
export function ReportsGrid({ inquiries, hasActiveFilters, onClearFilters }: ReportsGridProps) {
  if (inquiries.length === 0) {
    return (
      <EmptyReportsState hasActiveFilters={hasActiveFilters} onClearFilters={onClearFilters} />
    );
  }
