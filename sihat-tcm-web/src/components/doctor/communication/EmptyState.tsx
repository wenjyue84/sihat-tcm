  ...
  return (
    ...
    >
      ...
      <p className="text-gray-500 max-w-sm">
        Choose a patient from the inbox to view their messages and respond to their verification
        request.
      </p>
      ...
      <div className="mt-8 flex gap-4">
        <div className="bg-amber-50 border border-amber-100 rounded-lg px-4 py-2">
          ...
          <p className="text-xs text-amber-700 mt-1">Reply to activate the conversation</p>
        </div>
      </div>
    </motion.div>
  );
