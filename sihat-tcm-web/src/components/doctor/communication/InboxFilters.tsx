            ...
            <div className="flex gap-1 p-1 bg-gray-100/80 rounded-lg">
                {filterTabs.map((tab) => (
                    <button
                        ...
                        className={`relative flex-1 px-2 py-1.5 text-xs font-medium rounded-md transition-all ${filter === tab.key
                                ? "text-blue-700"
                    ...
                    >
                        ...
                        <span className="relative z-10 flex items-center justify-center gap-1">
                            ...
                            {counts[tab.key] > 0 && (
                                <span
                                    className={`px-1.5 py-0.5 text-[10px] rounded-full ${filter === tab.key
