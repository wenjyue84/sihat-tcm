          ...
          >
            ...
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-white">Diagnosis Preview</h2>
                  <p className="text-blue-100 text-sm">{conversation?.patient_name}</p>
                </div>
              </div>
              <Button
                variant="ghost"
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    {data.face_analysis?.observation && (
                      <div className="bg-pink-50 rounded-xl p-4 border border-pink-100">
                        ...
                        <p className="text-pink-700 text-xs">{data.face_analysis.observation}</p>
                      </div>
                    )}
                  </div>
