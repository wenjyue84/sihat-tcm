...
export function DoctorNavigation() {
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 h-14 bg-white border-b border-slate-200 flex items-center px-4 z-40">
        ...
        <div className="ml-auto">
          <Button
            ...
            onClick={() => router.push("/doctor/diagnose?step=patient-info")}
          >
            <Stethoscope className="w-4 h-4" />
          </Button>
        </div>
      ...
      <aside
        className={`lg:hidden fixed top-0 left-0 h-full w-72 bg-white shadow-xl z-50 flex flex-col transform transition-transform duration-300 ease-in-out ${
