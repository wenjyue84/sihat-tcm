              ...
              >
                ...
                <div className="flex flex-col gap-1 w-full">
                  {dayAppointments.map((apt) => (
                    <div
                      key={apt.id}
                      className={`text-[10px] px-1.5 py-0.5 rounded truncate w-full ${
        ...
        <div className="flex-1 overflow-y-auto space-y-3">
          {selectedAppointments.length === 0 ? (
            ...
            selectedAppointments.map((apt) => (
              <div
                key={apt.id}
                className="p-3 rounded-lg border border-slate-100 bg-slate-50 hover:border-blue-200 transition-colors"
              >
                ...
                {apt.notes && <div className="text-xs text-slate-400 italic">"{apt.notes}"</div>}
              </div>
            ))
          )}
        </div>
