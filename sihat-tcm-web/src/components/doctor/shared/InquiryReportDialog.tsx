...
export function InquiryReportDialog({ inquiry, patientProfile, trigger }: InquiryReportDialogProps) {
                ...
                <div className="mt-4 space-y-6">
                    ...
                    {diagnosis.summary && (
                        <div className="bg-green-50 p-4 rounded-lg border border-green-100">
                            ...
                            <p className="text-green-700 font-medium text-lg leading-snug">
                                {diagnosis.summary}
                            </p>
                            {diagnosis.tcmPattern && (
                                <p className="text-green-600 mt-1 font-serif text-lg">
                                    {diagnosis.tcmPattern}
                                </p>
                            )}
                        </div>
                            ...
                            <ul className="list-disc list-inside text-gray-700 space-y-2">
                                {Array.isArray(diagnosis.recommendations) ? (
                                    diagnosis.recommendations.map(
                                        (rec: string, i: number) => <li key={i} className="leading-relaxed">{rec}</li>
                                    )
                                ) : (
