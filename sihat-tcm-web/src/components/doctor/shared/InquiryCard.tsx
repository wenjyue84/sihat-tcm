  ...
  return (
    <Card
      className={cn(
        ...
        isDashboard
          ? "bg-white/90 backdrop-blur hover:shadow-lg active:scale-[0.99]"
          : "bg-white hover:shadow-md border-slate-200 active:scale-[0.995]",
        className
      )}
    >
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0 flex-1">
              ...
              <CardDescription className="flex items-center gap-2 text-xs sm:text-sm mt-0.5">
                ...
                <span>
                  {patientProfile?.age ? `${patientProfile.age} years old` : "Age unknown"}
                </span>
              </CardDescription>
            </div>
          </div>
          ...
          <div>
            ...
            <p
              className={cn(
                ...
                isDashboard
                  ? "text-gray-600 bg-gradient-to-r from-blue-50 to-indigo-50"
