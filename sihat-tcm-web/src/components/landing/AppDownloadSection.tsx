...
export function AppDownloadSection() {
  ...
  return (
    <section
      ...
      className="w-full bg-emerald-950 border-t border-emerald-900 overflow-hidden"
    >
      <div className="container mx-auto px-4 py-8 md:py-6 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
          ...
          <div className="flex items-center gap-4 text-center md:text-left">
            ...
            <div>
              <h2 className="text-lg md:text-xl font-bold text-white">{t.appDownload.title}</h2>
              <p className="text-sm text-emerald-300/80 mt-1 max-w-lg">{t.appDownload.subtitle}</p>
            </div>
          </div>
