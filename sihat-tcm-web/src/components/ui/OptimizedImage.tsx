...
export function OptimizedImage({
  ...
  const LoadingPlaceholder = () => (
    <div
      className={cn("animate-pulse bg-gray-200 dark:bg-gray-700 rounded", loadingClassName)}
      style={{
...
export function MedicalImage({ ...props }: OptimizedImageProps) {
  return (
    <OptimizedImage
      {...props}
      forceHighQuality={true}
