...
describe("ImageQualityOverlay", () => {
  ...
  it("should render quality overlay when visible", () => {
    const { container } = render(
      <ImageQualityOverlay qualityResult={mockQualityResult} isVisible={true} />
    );
  ...
  it("should not render when not visible", () => {
    const { container } = render(
      <ImageQualityOverlay qualityResult={mockQualityResult} isVisible={false} />
    );
  ...
  it("should not render when no quality result", () => {
    const { container } = render(<ImageQualityOverlay qualityResult={null} isVisible={true} />);
  ...
  it("should handle different quality levels", () => {
    ...
    qualityLevels.forEach((level) => {
      ...
      const { container } = render(<ImageQualityOverlay qualityResult={result} isVisible={true} />);
...
describe("CompositionGuideOverlay", () => {
  it("should render composition guide when visible", () => {
    const { container } = render(<CompositionGuideOverlay isVisible={true} mode="face" />);

    expect(container.firstChild).toBeTruthy();
  });

  it("should not render when not visible", () => {
    const { container } = render(<CompositionGuideOverlay isVisible={false} mode="face" />);
  ...
  it("should handle different modes", () => {
    ...
    modes.forEach((mode) => {
      const { container } = render(<CompositionGuideOverlay isVisible={true} mode={mode} />);
