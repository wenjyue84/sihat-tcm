...
export function ShowPromptButton({ promptType }: ShowPromptButtonProps) {
  ...
  const translations = {
    en: {
      ...
      developmentMessage:
        "As it is in development phase, you can click Login to view the system prompt. In future you will need to enter admin password to view.",
      login: "Login",
      cancel: "Cancel",
      close: "Close",
    ...
    zh: {
      ...
      loginAsAdmin: "管理员登录",
      developmentMessage:
        "目前为开发阶段，您可以直接点击登录查看系统提示词。正式版本需要输入管理员密码才能查看。",
      login: "登录",
      cancel: "取消",
      close: "关闭",
      systemPrompt: "系统提示词",
    ...
    ms: {
      ...
      developmentMessage:
        "Memandangkan ini adalah fasa pembangunan, anda boleh klik Log Masuk untuk melihat arahan sistem. Pada masa hadapan anda perlu memasukkan kata laluan pentadbir untuk melihat.",
      login: "Log Masuk",
      cancel: "Batal",
      close: "Tutup",
  ...
  const loadPrompt = async () => {
    ...
    try {
      ...
      } = await import("@/lib/systemPrompts");
              ...
              {!isAuthenticated ? (
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3 p-4 bg-amber-50 border border-amber-200 rounded-lg">
                    ...
                    <p className="text-amber-800 text-sm leading-relaxed">{t.developmentMessage}</p>
                  </div>
                </div>
              ) : isLoading ? (
                // Loading State
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2 text-sm text-emerald-600">
                    ...
                    <span>
                      {t.systemPrompt}: {t.promptTypeLabels[promptType]}
                    </span>
                  </div>
