        ...
        <div className="flex items-center gap-3">
          <div className="flex -space-x-2">
            {[...Array(Math.min(3, Math.max(1, familyMembersCount)))].map((_, i) => (
              <div
                key={i}
                className="w-8 h-8 rounded-full border-2 border-white bg-slate-200 flex items-center justify-center text-xs font-medium"
              >
                {familyMembersCount > 0 ? (
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="font-bold text-slate-800">
              {hasDiagnosis ? "Damp Heat" : t.healingGarden?.join || "Join Now"}
            </p>
          </div>
        </div>
      ),
    ...
    },
    {
      ...
      content: (
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xs font-medium text-violet-800 uppercase tracking-wider">
              Last Night
            </p>
