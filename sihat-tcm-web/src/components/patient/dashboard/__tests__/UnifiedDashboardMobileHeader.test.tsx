...
describe("UnifiedDashboardMobileHeader", () => {
  ...
  describe("Rendering", () => {
    it("renders the mobile header with all elements", () => {
      render(<UnifiedDashboardMobileHeader onMenuOpen={mockOnMenuOpen} t={mockTranslations} />);
    ...
    it("has correct fixed positioning classes", () => {
      const { container } = render(
        <UnifiedDashboardMobileHeader onMenuOpen={mockOnMenuOpen} t={mockTranslations} />
      );
  ...
  describe("Translations", () => {
    ...
    it("falls back to 'New' when translation is missing", () => {
      render(<UnifiedDashboardMobileHeader onMenuOpen={mockOnMenuOpen} t={{}} />);
