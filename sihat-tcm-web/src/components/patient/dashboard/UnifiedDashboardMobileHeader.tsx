...
export function UnifiedDashboardMobileHeader({
    onMenuOpen,
    t,
}: UnifiedDashboardMobileHeaderProps) {
    return (
                ...
                <Link href="/">
                    ...
                    >
                        ...
                        <span className="text-xs font-medium">
                            {((t.patientDashboard as Record<string, unknown> | undefined)?.navigation as Record<string, unknown> | undefined)?.newDiagnosis as string || "New"}
                        </span>
                    </Button>
                </Link>
            </div>
