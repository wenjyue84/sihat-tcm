                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-slate-500">
                        Captured {formatDuration(recordingDuration)} of audio. Ready for AI-TCM
                        analysis.
                      </p>
                    </div>
                ...
                {analysisResult && (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div
                        className={`p-6 rounded-3xl flex flex-col justify-between border ${analysisResult.snoring_detected ? "bg-orange-50/50 border-orange-100" : "bg-emerald-50/50 border-emerald-100"}`}
                      >
                        <div className="flex items-center gap-3 mb-4">
                          {analysisResult.snoring_detected ? (
                        ...
                        <div className="flex items-end justify-between">
                          ...
                          <span
                            className={`px-4 py-1 rounded-full text-sm font-bold ${getSeverityColor(analysisResult.severity)}`}
                          >
                      ...
                      <div className="p-6 rounded-3xl bg-slate-50 border border-slate-100 flex flex-col justify-between">
                        ...
                        <div className="flex items-end justify-between">
                          ...
                          <span className="text-2xl font-black text-slate-800">
                            ...
                            <small className="text-xs ml-1 text-slate-400 uppercase font-bold">
                              /min
                            </small>
                          </span>
                        </div>
                      ...
                      <div className="relative z-10 space-y-6">
                        <div className="flex items-center gap-3">
                          ...
                          <h4 className="text-xl font-bold tracking-tight">
                            TCM Pattern: {analysisResult.tcm_analysis.pattern}
                          </h4>
                        </div>
                          ...
                          <div className="space-y-4">
                            <div>
                              ...
                              <p className="text-emerald-50/80 leading-relaxed">
                                {analysisResult.tcm_analysis.explanation}
                              </p>
                            </div>
                            <div>
                              ...
                              <p className="text-red-50/90 leading-relaxed font-medium">
                                {analysisResult.tcm_analysis.fatigue_correlation}
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="bg-white/5 rounded-2xl p-5 backdrop-blur-md border border-white/10">
                            ...
                            <div className="mt-6">
                              ...
                              <div className="text-sm italic text-emerald-50/60">
                                In TCM, the sound of snoring is a "listening diagnosis" (闻诊) that
                                reveals the state of Qi and Phlegm in the body.
                              </div>
                            </div>
                          </div>
                        </div>
          ...
          <Card className="border-none shadow-lg bg-gradient-to-br from-indigo-50 to-blue-50/30 rounded-3xl">
            ...
            <CardContent className="p-6 pt-0">
              <p className="text-sm text-slate-600 leading-relaxed font-medium">
                ...
                balance of internal organs. Snoring is often a result of "Phlegm and Qi struggling"
                in the throat.
              </p>
