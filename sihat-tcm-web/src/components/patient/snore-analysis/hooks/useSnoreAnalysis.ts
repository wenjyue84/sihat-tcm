...
interface UseSnoreAnalysisReturn {
  ...
  analyzeAudio: (audioBlob: Blob, recordingDuration: number, tcmContext: TCMContext | null) => Promise<void>;
  resetAnalysis: () => void;
  error: string | null;
  setError: (error: string | null) => void;
}

export function useSnoreAnalysis(
  errorMessages: { analysisFailed: string }
