  ...
  const getPatternInsights = (patternName: string) => {
    ...
    if (lowerPattern.includes("improving") || lowerPattern.includes("stable")) {
      return {
        ...
        icon: "🌟",
        message:
          "Your pattern shows stability and improvement. This is exactly what we want to see in TCM treatment!",
        tips: [
    ...
    if (lowerPattern.includes("deficiency")) {
      return {
        ...
        icon: "💪",
        message:
          "Deficiency patterns are common and highly treatable with proper nourishment and rest.",
        tips: [
    ...
    return {
      ...
      icon: "🌿",
      message:
        "Understanding your pattern is the first step to targeted wellness. Your TCM practitioner can provide personalized guidance.",
      tips: [
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="bg-slate-50 rounded-xl p-4 border border-slate-200">
                <h4 className="font-semibold text-slate-800 mb-3">
                  Wellness Tips for This Pattern
                </h4>
              ...
              <div className="bg-gradient-to-br from-violet-50 to-purple-50 rounded-xl p-4 border border-violet-200">
                ...
                <p className="text-sm text-violet-700 leading-relaxed">
                  Patterns in TCM are not permanent labels — they're snapshots of your current
                  state. With proper care, diet, and lifestyle adjustments, patterns can shift
                  toward greater balance. You're already on the right path by tracking your health!
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-4 border border-amber-200">
                <p className="text-sm text-amber-800 leading-relaxed">
                  🌿 <strong>TCM Philosophy:</strong> Each pattern represents a unique combination
                  of Yin, Yang, Qi, and Blood dynamics in your body. Recognizing your pattern allows
                  for precisely targeted treatments that address root causes, not just symptoms.
                </p>
              </div>
            </div>
          </Dialog.Content>
