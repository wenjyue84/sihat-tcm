...
import { Clock, Star, Leaf, X } from "lucide-react";
...
export function JourneyDurationModal({
  ...
  const getJourneyMilestone = (days: number) => {
    if (days >= 365)
      return {
        title: "Year-Long Wellness Veteran",
        icon: "🎖️",
        message: "A full year of health dedication! Your body thanks you.",
      };
    if (days >= 180)
      return {
        title: "Half-Year Health Hero",
        icon: "🌟",
        message: "Six months of consistent self-care. Remarkable commitment!",
      };
    if (days >= 90)
      return {
        title: "Quarterly Champion",
        icon: "⭐",
        message: "Three months of health focus. You're building lasting habits!",
      };
    if (days >= 30)
      return {
        title: "Monthly Milestone",
        icon: "🌱",
        message: "One month into your journey. Great foundation!",
      };
    return {
      title: "Fresh Start",
      icon: "✨",
      message: "Every journey begins with a single step. You've taken it!",
    };
  };
            ...
            <div className="p-6 space-y-6">
                  ...
                  <div className="relative pl-4 border-l-2 border-violet-300 space-y-4">
                    <div className="relative">
                      ...
                      <p className="text-xs text-slate-500">
                        {firstSession.toLocaleDateString("en-US", {
                          month: "long",
                          day: "numeric",
                          year: "numeric",
                        })}
                    ...
                    {validSessions.length > 1 && (
                      <div className="relative">
                        ...
                        <p className="text-sm font-medium text-slate-800">
                          {validSessions.length - 2} Sessions In Between
                        </p>
              ...
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-4 border border-amber-200">
                <p className="text-sm text-amber-800 leading-relaxed">
                  🌿 <strong>TCM Perspective:</strong> Healing follows natural rhythms. Just as
                  seasons change gradually, your body's return to balance is a journey, not a
                  destination. The time you've invested shows wisdom and patience — qualities that
                  TCM considers essential for true wellness.
                </p>
              </div>
            </div>
          </Dialog.Content>
