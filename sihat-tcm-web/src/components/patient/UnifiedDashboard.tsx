...
export function UnifiedDashboard() {
  ...
  const getSectionTitle = () => {
    switch (activeSection) {
      ...
      case "five-elements":
        return t.patientDashboard?.tabs?.fiveElements || "Circle of Health";
      case "meals":
      ...
      case "profile":
        return t.patientDashboard?.tabs?.profile || "Profile";
      case "documents":
        return t.patientDashboard?.tabs?.documents || "Documents";
      case "settings":
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="space-y-1">
                ...
                <button
                  onClick={() => {
                    setActiveSection("five-elements");
                    setIsMobileMenuOpen(false);
                  }}
                ...
                {sessions.length > 0 ? (
                  <>
                    <p className="text-slate-600 mb-6">
                      {t.circleOfHealth?.subtitle || "Connect with others on similar healing journeys"}
                    </p>
                    <CircleOfHealth userConstitution={
                      sessions.length > 0 && sessions[0].constitution
                        ? extractConstitutionType(sessions[0].constitution)
                        : undefined
                    } />
