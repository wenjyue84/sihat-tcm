...
export function DoctorVerificationModal({
    ...
    const translations = {
        ...
        ms: {
            ...
            certified: "Disahkan",
            infoTooltip: "Pengamal TCM yang berkelayakan akan menyemak diagnosis AI anda dan memberikan maklum balas perubatan profesional. Data anda dikendalikan dengan selamat.",
            specialty: "Kepakaran",
        },
    };
...
function DoctorCard({
    ...
    return (
        <button
            ...
            className={`w-full p-4 rounded-xl border-2 transition-all text-left flex items-center gap-4 touch-manipulation min-h-[80px] ${isSelected
        ...
        >
            ...
            <div className="relative flex-shrink-0">
                {doctor.avatar_url ? (
                    ...
                    <div
                        className={`w-14 h-14 rounded-full flex items-center justify-center ${isMaster
                ...
                <div className="flex flex-wrap items-center gap-x-2 gap-y-0.5 text-sm text-gray-500">
                    ...
                    {doctor.years_experience && (
                        <>
                            ...
                            <span className="whitespace-nowrap">{doctor.years_experience}{translations.experience}</span>
                        </>
                    )}
                </div>
                {isMaster && (
