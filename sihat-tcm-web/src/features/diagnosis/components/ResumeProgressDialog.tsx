      ...
      <DialogContent className="sm:max-w-sm bg-white border-gray-200 shadow-xl">
        <DialogHeader className="space-y-2 pb-3">
          ...
          <DialogDescription className="text-center text-gray-600 text-sm leading-relaxed">
            {t.resumeProgress?.description ||
              "We found a previous diagnosis session. Would you like to continue where you left off?"}
          </DialogDescription>
        </DialogHeader>
        ...
        >
          <div className="flex items-center gap-2.5">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-xs text-gray-500 mb-0.5">{t.resumeProgress?.savedAt || "Saved"}</p>
