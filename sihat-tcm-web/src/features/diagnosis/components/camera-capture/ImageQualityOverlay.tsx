...
export function ImageQualityOverlay({
  ...
  return (
    <div className={`absolute top-2 left-2 right-2 z-20 pointer-events-none ${className}`}>
      ...
      <div
        className={`inline-flex items-center gap-2 px-3 py-2 rounded-lg border backdrop-blur-sm ${getQualityColor(qualityResult.overall)}`}
      >
        ...
        <span className="text-xs opacity-75">{qualityResult.score}%</span>
      </div>
