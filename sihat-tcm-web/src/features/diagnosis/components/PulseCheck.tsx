...
import { PulseGuide, BpmInput, PulseQualitySelector, usePulseCheck, PulseCheckData } from "./pulse";
...
export function PulseCheck({ onComplete, onBack, initialData }: PulseCheckProps) {
  ...
  const guideSteps = (t.pulse?.guideSteps || []) as Array<{
    title: string;
    description: string;
    tip: string;
  }>;
  ...
  return (
    <Card className="p-6 space-y-6 mb-20 md:mb-0">
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-3">
          ...
          <div className="relative p-2">
            ...
            <div className="relative bg-gradient-to-br from-rose-100 to-pink-100 rounded-xl p-2">
      ...
      {wizardStep === "bpm" && (
        <>
          {showGuide && (
            <PulseGuide steps={guideSteps} guideStep={guideStep} setGuideStep={setGuideStep} />
          )}
          <BpmInput
            inputMode={inputMode}
