...
describe('EnhancedProgressStepper', () => {
  ...
  describe('Interactions', () => {
    ...
    it('should show guidance tooltip when help button is clicked', async () => {
      ...
      expect(screen.getByText('Please provide accurate information for better diagnosis')).toBeInTheDocument();
    });
  ...
  describe('Keyboard Navigation', () => {
    ...
    it('should handle Enter key for step activation', async () => {
      ...
      render(<EnhancedProgressStepper {...defaultProps} onStepClick={onStepClick} enableKeyboardNavigation={true} />);
