...
import type { StepDefinition } from '@/components/diagnosis/EnhancedProgressStepper';
...
export function useDiagnosisSteps(config: DiagnosisStepsConfig = {}) {
    ...
    const baseSteps: StepDefinition[] = [
      {
        ...
        guidance: {
          ...
          content: 'Please provide accurate information about yourself to help us give you the best diagnosis.',
          tips: [
      ...
      },
      {
        ...
        guidance: {
          ...
          content: 'This step involves answering questions about your symptoms, lifestyle, and health history.',
          tips: [
      ...
      },
      {
        ...
        guidance: {
          ...
          content: 'Pulse information helps us understand your cardiovascular health and energy levels.',
          tips: [
  ...
  const getAvailableSteps = (completedSteps: string[]) => {
    return stepDefinitions.filter(step => 
      validateStepPrerequisites(step.id, completedSteps)
    );
  };
