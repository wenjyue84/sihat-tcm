...
const poolerUrl =
  "postgresql://postgres.kixqmquwqzvcvdvfnfar:Jackjack1!@aws-0-ap-southeast-1.pooler.supabase.com:6543/postgres";

// Strategy 2: Direct Connection (Port 5432)
// Uses the direct DB host
const directUrl =
  "postgresql://postgres:Jackjack1!@db.kixqmquwqzvcvdvfnfar.supabase.co:5432/postgres";
