...
const medications = [
  {
    name: "Duloxetine (Duloxpra)",
    chinese_name: "神经痛药",
    dosage: "As prescribed",
    frequency: null,
    start_date: "2025-11-17",
    stop_date: "2025-12-10",
    purpose: "Nerve pain/muscle relaxation",
    specialty: "疼痛科",
    is_active: false,
    edited_by: "wenjyue lew",
  },
  {
    name: "Remeron SolTab (Mirtazapine)",
    chinese_name: "安眠抗焦虑药",
    dosage: "15mg nightly",
    frequency: "Nightly",
    start_date: "2020-01-01",
    stop_date: null,
    purpose: "Mental health / sleep / anxiety (精神科)",
    specialty: "精神科",
    is_active: true,
    edited_by: "wenjyue lew",
  },
  {
    name: "Normaten (Atenolol)",
    chinese_name: "心跳药",
    dosage: "50mg daily",
    frequency: "Daily",
    start_date: "2020-01-01",
    stop_date: null,
    purpose: "Slow heart rate control (心脏跳慢)",
    specialty: "心脏科",
    is_active: true,
    edited_by: "wenjyue lew",
  },
  {
    name: "Lexoton (Bromazepam)",
    chinese_name: "安眠镇静药",
    dosage: "As prescribed",
    frequency: null,
    start_date: "2025-11-17",
    stop_date: null,
    purpose: "Anxiety/sleep",
    specialty: "精神科",
    is_active: true,
    edited_by: "wenjyue lew",
  },
  {
    name: "Joint supplements (replaced by Mobithron Advance)",
    chinese_name: "关节保健品",
    dosage: "1 month course",
    frequency: null,
    start_date: null,
    stop_date: "2025-12-05",
    purpose: "Knee arthritis",
    specialty: "骨科",
    is_active: false,
    edited_by: "wenjyue lew",
  },
  {
    ...
    start_date: "2020-01-01",
    stop_date: null,
    purpose: "Diabetes management (kencing manis/糖尿病)",
    specialty: "内分泌科",
    is_active: true,
    edited_by: "wenjyue lew",
  },
  {
    ...
    chinese_name: "降血压护肾药",
    dosage: "10mg/160mg daily",
    frequency: "Daily",
    start_date: "2020-01-01",
    stop_date: null,
    purpose: "High blood pressure + kidney protection (高血压)",
    specialty: "肾脏科",
    is_active: true,
    edited_by: "wenjyue lew",
  },
  {
    ...
    start_date: "2020-01-01",
    stop_date: null,
    purpose: "Cholesterol control (降胆固醇)",
    specialty: "心脏科",
    is_active: true,
    edited_by: "wenjyue lew",
  },
  ...
  },
  {
    ...
    stop_date: "2025-12-10",
    purpose: "Antibiotic (1 week course)",
    specialty: "感染科",
    is_active: false,
    edited_by: "wenjyue lew",
  },
  {
    name: "Mobithron Advance (100/10/45mg)",
    chinese_name: "骨关节药",
    dosage: "1 capsule once daily",
    frequency: "Once daily",
    start_date: "2025-12-05",
    stop_date: null,
    purpose: "Bone/joint health (collagen, hyaluronic acid, boswellia)",
    specialty: "骨科",
    is_active: true,
    edited_by: "wenjyue lew",
  },
  {
    name: "Simethicone (Gascoal)",
    chinese_name: "消胀气药",
    dosage: "50mg, 3 times daily",
    frequency: "3 times daily",
    start_date: "2025-12-05",
    stop_date: null,
    purpose: "Anti-gas/bloating (胀风)",
    specialty: "胃科",
    is_active: true,
    edited_by: "wenjyue lew",
  },
  {
    name: "Brintellix (Vortioxetine)",
    chinese_name: "抗抑郁药",
    dosage: "10mg, ½ tablet at bedtime",
    frequency: "Bedtime",
    start_date: "2025-12-09",
    stop_date: null,
    purpose: "Antidepressant/anxiety (from Dr. Chan)",
    specialty: "精神科",
    is_active: true,
    edited_by: "wenjyue lew",
  },
...
async function seed() {
  ...
  try {
    ...
    if (!userId) {
      console.log(
        "⚠️  Could not find user via auth.admin (missing service role?). Trying to find profile by name..."
      );
