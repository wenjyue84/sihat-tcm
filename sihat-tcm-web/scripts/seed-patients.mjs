...
async function seedPatients() {
    try {
        ...
        // Name arrays
        const cnFirstNames = ['Wei', 'Jun', 'Ying', 'Mei', 'Hui', 'Xin', 'Yee', 'Kang', 'Ming', 'Siew', 'Chee', 'Boon', 'Kian', 'Kah', 'Mun', 'Ah', 'Kok', 'Siong', 'Pei', 'Li', 'Jia', 'Yi', 'Zhi', 'Xue'];
        const cnLastNames = ['Tan', 'Lee', 'Wong', 'Lim', 'Chong', 'Ng', 'Chin', 'Liew', 'Chan', 'Low', 'Teoh', 'Seow', 'Ong', 'Goh', 'Chua', 'Khoo', 'Loh', 'Yeoh', 'Ewe', 'Sim', 'Ang', 'Teo', 'Koh', 'Phua'];
        const myFirstNames = ['Ahmad', 'Muhammad', 'Siti', 'Nur', 'Farah', 'Amir', 'Zainal', 'Aishah', 'Ismail', 'Fatimah', 'Syahir', 'Izzat', 'Haris', 'Haziq', 'Nurul', 'Puteri', 'Adam', 'Amina'];
        const myLastNames = ['Abdullah', 'Ibrahim', 'Yusof', 'Rahman', 'Hassan', 'Aziz', 'Zakaria', 'Mohamad', 'Ali', 'Omar', 'Othman', 'Razak', 'Bakar'];
        const inFirstNames = ['Ravi', 'Priya', 'Kumar', 'Anjali', 'Sanjay', 'Devi', 'Vijay', 'Geetha', 'Muthu', 'Kavita', 'Suresh', 'Deepa', 'Balan', 'Meena', 'Vikram', 'Lakshmi'];
        const inLastNames = ['Subramaniam', 'Krishnan', 'Raman', 'Menon', 'Pillai', 'Rao', 'Singh', 'Kaur', 'Govindasamy', 'Rajagopal', 'Manickam', 'Fernandes', 'Nair'];
        ...
        for (let i = 1; i <= 100; i++) {
            ...
            const patient = {
                ...
                birth_date: new Date(Date.now() - Math.random() * 365.25 * 90 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
